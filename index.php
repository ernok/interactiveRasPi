...
// Remove Colourpoint and colourbalance as they kill the camera
   ...
   function getLoadClass() {
	...
	if( $_GET["textOutput"]) {
      echo "Testing 1". $_GET['textOutput']. "<br />";
      exit();
   }  
...
<a href="#" onclick="doBg();">Bluegreen</a>
<br>
<script type="text/javascript" src="jquery.min.js"></script>
<script type="text/javascript">
function doY() {
...
<a href="#" onclick="doW();">White</a>
<br>
      <center><form action = "<?php $_PHP_SELF ?>" method = "POST">
         Enter Text Here: <input type = "text" name = "textOutput" />
         <input type = "submit" />
      </form></center>

<form name="search" action="/cgi-bin/outputText.py" method="get">
...
<INPUT TYPE="submit" VALUE="About Project">
</FORM>
		 </div>
            </div>
         </div>
